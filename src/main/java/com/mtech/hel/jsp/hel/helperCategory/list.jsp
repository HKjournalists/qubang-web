...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript" src="${ctx}/static/hel/helperCategory/list.js"></script>
  </head>
...
<body>
    ...
    <div class="contentbox inner5 top5">
        <form id="helperCategoryQueryForm">
          	<table cellpadding="0" cellspacing="0" class="l-table">
			             ...
			             <td align="left">
			  				<input type="text" ltype="text" stype="like" name="categoryName" id="categoryName" />
			             </td>
			         
		      
			             <td align="right">父级编号：</td>
			             <td align="left">
			  				<input type="text" ltype="text" stype="eq" name="parentCode" id="parentCode" />
			             </td>
