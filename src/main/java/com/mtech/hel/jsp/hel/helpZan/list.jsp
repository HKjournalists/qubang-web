...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript" src="${ctx}/static/hel/helpZan/list.js"></script>
  </head>
...
<body>
    ...
    <div class="contentbox inner5 top5">
        <form id="helpZanQueryForm">
          	<table cellpadding="0" cellspacing="0" class="l-table">
		      
			      	     <tr>
			             <td align="right">用户ID：</td>
			             <td align="left">
			  				<input type="text" ltype="text" stype="eq" name="zanUserId" id="zanUserId" />
			             </td>
