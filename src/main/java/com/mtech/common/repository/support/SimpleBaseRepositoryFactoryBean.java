...
import com.mtech.common.repository.support.annotation.SearchableQuery;
...
class SimpleBaseRepositoryFactory<M, ID extends Serializable> extends JpaRepositoryFactory {
    ...
    protected Object getTargetRepository(RepositoryMetadata metadata) {
        ...
        if (isBaseRepository(repositoryInterface)) {
            ...
            SimpleBaseRepository repository = new SimpleBaseRepository<M, ID>(entityInformation, entityManager, repositoryInterface);
