...
<div class="contentbox top5">
	<form style="margin-left: 30px;" name="form1" id="form1" action="${ctx}/usr/userSuggest/save.json" method="post" submitType="ajaxSubmit" ajaxCallBack="formCallBack">
		...
		<table cellpadding="0" cellspacing="0" class="l-table">
		            ...
		            <tr>
						...
						<td align="left"  style="width:160px">
							<input name="suggestDesc" type="text"  ltype="text" validate="" />
						</td>
						<td align="left"></td>
					</tr>
		            <tr>
						...
						<td align="left"  style="width:160px">
							<input name="status" type="text"  ltype="text" validate="" />
						</td>
						<td align="left"></td>
					</tr>
		            <tr>
						...
						<td align="left"  style="width:160px">
							<input name="auditResult" type="text"  ltype="text" validate="" />
						</td>
						<td align="left"></td>
					</tr>
		            <tr>
						...
						<td align="left"  style="width:160px">
							<input name="auditId" type="text"  ltype="text" validate="" />
						</td>
						<td align="left"></td>
					</tr>
		</table>
